$(function(){
  ...
  if (window.location.pathname == '/map') {
    ...
    // Create the search box and link it to the UI element.
      ...
      // map.controls[google.maps.ControlPosition.TOP_LEFT].push(destInput);
    ...
    function searchWaypoint() {
      ...
      // Create the search box and link it to the UI element.
      wayInput = (document.getElementById('way-input'));
      map.controls[google.maps.ControlPosition.TOP_RIGHT].push(wayInput);

      var searchBox = new google.maps.places.SearchBox((wayInput));
